...
public class Cards
	{
		public static ArrayList<CardType> card = new ArrayList<CardType>();
		
		public static void main(String[] args)
		{
			
			card.add(new CardType("Red" , 0 , "0"));
			card.add(new CardType("Red" , 1 , "1"));
			card.add(new CardType("Red" , 2 , "2"));
			card.add(new CardType("Red" , 3 , "3"));
			card.add(new CardType("Red" , 4 , "4"));
			card.add(new CardType("Red" , 5 , "5"));
			card.add(new CardType("Red" , 6 , "6"));
			card.add(new CardType("Red" , 7 , "7"));
			card.add(new CardType("Red" , 8 , "8"));
			...
			card.add(new CardType("Yellow" , 4 , "4"));
			card.add(new CardType("Yellow" , 5 , "5"));
			card.add(new CardType("Yellow" , 6 , "6"));
			card.add(new CardType("Yellow" , 7 , "7"));
			card.add(new CardType("Yellow" , 8 , "8"));
			...
			card.add(new CardType("Blue" , 4 , "4"));
			card.add(new CardType("Blue" , 5 , "5"));
			card.add(new CardType("Blue" , 6 , "6"));
			card.add(new CardType("Blue" , 7 , "7"));
			card.add(new CardType("Blue" , 8 , "8"));
			...
			card.add(new CardType("Green" , 4 , "4"));
			card.add(new CardType("Green" , 5 , "5"));
			card.add(new CardType("Green" , 6 , "6"));
			card.add(new CardType("Green" , 7 , "7"));
			card.add(new CardType("Green" , 8 , "8"));
